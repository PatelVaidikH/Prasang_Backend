        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('addVendorPost') }}" method="POST">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="">Vendor Password</label>
                    <input type="password" name="vendor_password" class="form-control" placeholder="Enter Password" required>
                  </div>
                </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" class="btn btn-warning">Add Vendor</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
