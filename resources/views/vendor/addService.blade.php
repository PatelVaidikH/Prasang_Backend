        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('addServicePost') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" name="starting_price" placeholder="Enter Starting Price">
                      </div>
                  </div>
                  <div class="form-group">
                    <label for="">Short Description</label>
                    <input type="text" class="form-control" name="service_short_description" placeholder="Enter Short Description">
                  </div>
                  <div class="form-group">
                    <label for="">Long Description</label>
                    <textarea type="text" class="form-control" name="service_long_description" placeholder="Enter Long Description"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Service Cover Photo</label>
